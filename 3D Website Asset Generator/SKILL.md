...
|---|---|---|
| **scroll-stop-prompter** | `SKILL.md` (this file, below) | "scroll-stop prompt", "deconstruction prompt", "exploded view prompt", "product animation prompt" |
| **3d-scroll-engineer** | `../.claude/skills/3d-scroll-engineer.md` | "scroll animation", "3D scroll", "parallax", "scroll-based", "section transition", "scroll reveal" |
